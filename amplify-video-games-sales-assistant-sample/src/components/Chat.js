...
const Chat = ({ userName = "Guest User" }) => {
  ...
  const handleQuery = (event) => {
    if (event.target.value.length > 0 && loading === false)
      setEnabled(true);
                ...
                {answer.hasOwnProperty("text") ? (
                  ...
                  <Grid container justifyContent="flex-end">
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      ...
                      >
                        <Typography variant="body1" color="white">{answer.query}</Typography>
                      </Box>
                      <Box sx={{ pl: 1, pt: 1.5, pr: 2.5}}>
                        <img
                          src="/images/user-profile-active.png"
                          alt="User"
                          width={24}
                          height={24}
                        />
