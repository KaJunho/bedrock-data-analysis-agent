  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      ...
      <AppBar
        ...
        color="default"
        elevation={0}
        sx={{ borderBottom: (theme) => `1px solid ${theme.palette.divider}`, bgcolor: "#161d26"}}
      >
      ...
      <Container disableGutters maxWidth="lg" component="main" sx={{ borderRight: 0 }}>
